...
public class DoubleLinkedListTest {
	...
	public final void testAddT3() {
		populateList();
		list.add("Barb");
		assertNotNull(list.getNodeAt(6).getPrev());
	}
	...
	public final void testAddIntT2a() {
		populateList();
		list.add("yup", 1, "Barb");
		assertTrue(list.getNodeAt(2).getPrev() != null);
	}
	...
	public final void testAddIntT3a() {
		populateList();
		list.add("yup", 3, "Barb");
		assertNotNull(list.getNodeAt(3).getPrev());
	}
	...
	public final void testAddIntT3b() {
		populateList();
		list.add("yup", 3, "Barb");
		assertEquals(list.getNodeAt(4).getPrev(), list.getNodeAt(3));
	...
	public final void testAddIntT4() {
		populateList();
		list.add("yup", 6, "Barb");
		assertNull(list.getLast().getNext());
	}
	...
	public final void testRemove1b() {
		populateList();
		list.remove(1);
		assertNull(list.getFirst().getPrev());
	}
	...
	public final void testRemove3b() {
		populateList();
		list.remove(3);
		assertEquals("Dustin", ((list.getNodeAt(3)).getPrev()).getValue());
	}
